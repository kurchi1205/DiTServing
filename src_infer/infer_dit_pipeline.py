...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", type=str, default="../results/base_infer_image.jpg", help="Output file name")
    ...
    # Generate the image
    image = generate(pipe, args.prompt, args.num_inference_steps)
