...
# pytest test_base_pipeline_service.py --benchmark-json results/benchmark_results_sd3.json
# pytest test_base_pipeline_service.py --benchmark-json results/benchmark_results_sd3_compiled.json
