...
torch-model-archiver --model-name dit-model-compiled -f --version 1.0 --handler dit_handler.py --extra-files "model.zip,base_pipeline_dit.py" -r requirements.txt --export-path model_store 
